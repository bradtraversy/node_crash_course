...
//   // File append = adds to previous text - Async
//   // append is used inside callback of writeFile.
//   // but you can call it outside also...
...
// Rename file - Async
// hello.text is renamed to helloworld.txt
...
const users = [{ name: "Kaddy" }, { name: "Marc" }, { name: "Prince" }, { name: "Kally" }];
